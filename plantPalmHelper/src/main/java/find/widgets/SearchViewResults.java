...
import find.interfaces.onSearchActionsListener;
...
public class SearchViewResults implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    * */
    ...
    /*
    What is for ?! Because it's don't work in proper way
    @Override
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
    ...
    */
    private ArrayList<String> findItem(String query, int page) {
        ...
        result = (ArrayList<String>) Entry_Activity.db.getZdNotClear(query);
